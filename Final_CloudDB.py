...
url="https://attendance-aswin-201430837078-ap-southeast-2-an.s3.ap-southeast-2.amazonaws.com/attendance.csv"
df=pd.read_csv(url)
...
if c==1:
  ...
  if sql == "SQL":
    query="SELECT employee_name,COUNT(*) AS attendance_count FROM attendance GROUP BY employee_name"
  ...
  sql=st.selectbox("Choose method:",["SQL","Python"])
  if sql == "SQL":
    query="SELECT employee_name, (23 - COUNT(*)) AS absences FROM attendance GROUP BY employee_name"
    r=pd.read_sql(query,conn)
    st.dataframe(r)
  elif sql=="Python":
    r1=23-r
  ...
  sql=st.selectbox("Choose method:",["SQL","Python"])
  if sql == "SQL":
    query="SELECT employee_name,SUM(CASE WHEN check_in > '9:15' THEN '1' ELSE '0' END) AS late_count FROM attendance GROUP BY employee_name"
    r=pd.read_sql(query,conn)
    st.dataframe(r)
  elif sql=="Python":
  ...
  sql=st.selectbox("Choose method:",["SQL","Python"])
  if sql == "SQL":
    query="SELECT employee_name,COUNT(*) AS days_worked FROM attendance GROUP BY employee_name HAVING COUNT(*) = ( SELECT MAX(days_worked) FROM (SELECT COUNT(*) AS days_worked FROM attendance GROUP BY employee_name) AS Attendance)"
    r=pd.read_sql(query,conn)
    st.dataframe(r)
  elif sql=="Python":
    max1=r.max()
  ...
  sql=st.selectbox("Choose method:",["SQL","Python"])
  if sql == "SQL":
    query="SELECT employee_name,(23 - COUNT(*)) AS absences FROM attendance GROUP BY employee_name HAVING COUNT(*) = ( SELECT MIN(absences_count) FROM (SELECT COUNT(*) AS absences_count FROM attendance GROUP BY employee_name) AS Absences)"
    r=pd.read_sql(query,conn)
    st.dataframe(r)
  elif sql=="Python":
    r1=23-r
  ...
  sql=st.selectbox("Choose method:",["SQL","Python"])
  if sql == "SQL":
    query="SELECT employee_name,SUM(CASE WHEN check_out < '18:00' THEN '1' ELSE '0' END) AS late_count FROM attendance GROUP BY employee_name"
    r=pd.read_sql(query,conn)
    st.dataframe(r)
  elif sql=="Python":
  ...
  sql=st.selectbox("Choose method:",["SQL","Python"])
  if sql == "SQL":
    query="SELECT DISTINCT employee_name FROM attendance WHERE employee_name LIKE 'A%'"
    r=pd.read_sql(query,conn)
    st.dataframe(r)
  elif sql=="Python":
  ...
  sql=st.selectbox("Choose method:",["SQL","Python"])
  if sql == "SQL":
    query="SELECT DISTINCT employee_name FROM attendance WHERE employee_name LIKE '%r%' AND employee_name LIKE '%s%'"
    r=pd.read_sql(query,conn)
    st.dataframe(r)
  elif sql=="Python":
  ...
  sql=st.selectbox("Choose method:",["SQL","Python"])
  if sql == "SQL":
    query="SELECT employee_name FROM attendance WHERE date = '6/9/2026'"
    r=pd.read_sql(query,conn)
    st.dataframe(r)
  elif sql=="Python":
